...
public class SuperButton extends AppCompatButton {
    ...
    public SuperButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundArc = a.getBoolean(R.styleable.SuperButton_backgroundArc, false);
        mRadius = a.getDimension(R.styleable.SuperButton_android_radius, 0);
        mTopLeftRadius = a.getDimension(R.styleable.SuperButton_android_topLeftRadius, 0);
        mTopRightRadius = a.getDimension(R.styleable.SuperButton_android_topRightRadius, 0);
        mBottomLeftRadius = a.getDimension(R.styleable.SuperButton_android_bottomLeftRadius, 0);
        mBottomRightRadius = a.getDimension(R.styleable.SuperButton_android_bottomRightRadius, 0);

        mBackgroundColor = a.getColor(R.styleable.SuperButton_backgroundColor, Color.TRANSPARENT);
        mBackgroundColorEnabled = a.getColor(R.styleable.SuperButton_backgroundColorEnabled, mBackgroundColor);
        mBackgroundColorPressed = a.getColor(R.styleable.SuperButton_backgroundColorPressed, mBackgroundColor);
        mStrokeWidth = a.getDimensionPixelOffset(R.styleable.SuperButton_strokeWidth, 0);
        mStrokeColor = a.getColor(R.styleable.SuperButton_strokeColor, Color.TRANSPARENT);
        mStrokeColorEnabled = a.getColor(R.styleable.SuperButton_strokeColorEnabled, mStrokeColor);
        mStrokeColorPressed = a.getColor(R.styleable.SuperButton_strokeColorPressed, mStrokeColor);
