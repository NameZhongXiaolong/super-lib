...
public class SuperTextView extends AppCompatTextView {
    ...
    public SuperTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean backgroundArc = a.getBoolean(R.styleable.SuperTextView_backgroundArc, false);
        float radius = a.getDimension(R.styleable.SuperTextView_android_radius, 0);
        float topLeftRadius = a.getDimension(R.styleable.SuperTextView_android_topLeftRadius, 0);
        float topRightRadius = a.getDimension(R.styleable.SuperTextView_android_topRightRadius, 0);
        float bottomLeftRadius = a.getDimension(R.styleable.SuperTextView_android_bottomLeftRadius, 0);
        float bottomRightRadius = a.getDimension(R.styleable.SuperTextView_android_bottomRightRadius, 0);

        int backgroundColor = a.getColor(R.styleable.SuperTextView_backgroundColor, Color.TRANSPARENT);
        int backgroundColorEnabled = a.getColor(R.styleable.SuperTextView_backgroundColorEnabled, StateListDrawableHelper.DEF_COLOR);
        int backgroundColorPressed = a.getColor(R.styleable.SuperTextView_backgroundColorPressed, StateListDrawableHelper.DEF_COLOR);
        int backgroundColorChecked = a.getColor(R.styleable.SuperTextView_backgroundColorChecked, StateListDrawableHelper.DEF_COLOR);

        int strokeWidth = a.getDimensionPixelOffset(R.styleable.SuperTextView_strokeWidth, 0);
        int strokeColor = a.getColor(R.styleable.SuperTextView_strokeColor, Color.TRANSPARENT);

        int strokeColorEnabled = a.getColor(R.styleable.SuperTextView_strokeColorEnabled, strokeColor);
        int strokeColorPressed = a.getColor(R.styleable.SuperTextView_strokeColorPressed, strokeColor);
        int strokeColorChecked = a.getColor(R.styleable.SuperTextView_strokeColorChecked, strokeColor);
